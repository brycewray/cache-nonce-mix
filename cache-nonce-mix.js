...
async function handleRequest(request) {
  ...
  if (ttl) {
    ...
    newHeaders.set("Content-Security-Policy-Report-Only", `report-uri https://brycewray.report-uri.com/r/d/csp/reportOnly; default-src 'self' https://*.brycewray.com; connect-src 'self' https://*.brycewray.com https://*.cloudinary.com https://*.cloudflareinsights.com https://*.ytimg.com https://*.ggpht.com https://*.youtube-nocookie.com; base-uri 'self' https://*.brycewray.com; frame-src 'self' https://*.brycewray.com https://*.youtube-nocookie.com; frame-ancestors 'self' https://*.brycewray.com https://*.youtube-nocookie.com; form-action 'self'; style-src 'self' https://*.brycewray.com https://*.youtube-nocookie.com data:; style-src-attr 'self' https://*.brycewray.com; img-src 'self' https://*.brycewray.com https://*.cloudinary.com https://*.ytimg.com https://*.ggpht.com https://*.youtube-nocookie.com data:; font-src 'self' https://*.brycewray.com https://*.gstatic.com; script-src 'nonce-${nonce}' 'strict-dynamic' https: 'self'; script-src-elem 'self' https://*.brycewray.com 'nonce-${nonce}'`)
